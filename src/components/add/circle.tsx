...
export default function AddCircle(props: AddCircleProps) {
  ...
  return (
    <Fragment>
      ...
      >
        {circle && (
          <div className="flex flex-col">
            <div className="flex justify-center">{circle.name}</div>
        ...
        onClick={async (e) => {
          ...
          if (circle) {
            ...
            if (formRef.current) {
              ...
              const file = (formRef.current.circleImage as HTMLInputElement)
                .files?.[0];
              ...
              const duplicateCheck = {
                ...
                place: circles
                  ...
                  .find(
                    (c) =>
                      c.place === formData.place &&
                      c.day === formData.day &&
                      c.wing === formData.wing
                  ),
              };
      ...
      {warn && <div className="alert alert-warning mt-8">{warn}</div>}
    </Fragment>
  );
}
